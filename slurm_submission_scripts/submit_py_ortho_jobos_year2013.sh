...
python /work/d/druedaro/wv2_scripts/pgc_duplication/pgc_ortho.py -p 4326 -c ns -t UInt16 -f GTiff --no_pyramids $image $ortho_out
...
# matlab running
matlab -nodisplay -nodesktop -r "WV_Clasific_cleaner_v4_Jobos.m('$image2','$met','crd_sys','$areaName','$rrs_out','$SLURM_ARRAY_TASK_ID')"
